...
**Kiểm tra UI Feedback**: Nếu lỗi cần debug liên quan đến giao diện (visual, layout, spacing, màu sắc, font), tự động quét và đọc báo cáo lỗi giao diện từ `docs/tasks/[TASK-ID]/ui-feedback.md` (nếu có) để làm thông tin đầu vào phục vụ cho việc tái dựng (reproduce) và xác định vùng lỗi (localize).
